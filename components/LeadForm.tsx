  ...
  return (
    <button
      ...
      className={`w-full h-[52px] rounded-[10px] text-sm font-medium text-left px-4 transition-all duration-150 border ${
        selected
          ? "border-2 border-[#F05A1A] bg-[#FFF3EE] text-[#F05A1A] font-semibold"
          : "border-[1.5px] border-[#E2E8F0] bg-white text-[#1A1A1A] hover:border-[#F05A1A50] hover:bg-[#FFF8F6]"
      }`}
    >
      {label}
    </button>
      ...
      content: (
        <div className="flex flex-col gap-3">
          <input
            ...
            className={`w-full h-[52px] rounded-[10px] border px-4 text-sm focus:outline-none focus:border-[#F05A1A] transition-colors ${
    ...
    <div className="bg-white rounded-2xl shadow-xl p-7 w-full max-w-[420px]">
      ...
      <div className="mb-5">
        ...
        <div className="w-full h-1 bg-[#E2E8F0] rounded-full overflow-hidden">
          <div
            className="h-full bg-[#F05A1A] rounded-full transition-all duration-500 ease-in-out"
      ...
      <div className="mt-5 flex flex-col gap-3">
        {currentStep.btnLabel && (
          <button
            type="button"
            onClick={handleNext}
            className="w-full h-[52px] rounded-[10px] bg-[#F05A1A] text-white font-semibold text-sm hover:bg-[#D44C12] transition-colors"
          >
            {currentStep.btnLabel}
          </button>
        )}
